  ...
  return (
    <section className="space-y-8">
      <header className="space-y-3">
        <span className="inline-block rounded-[var(--radius-full)] bg-[var(--color-accent-soft)] px-3 py-1 text-xs font-semibold tracking-wide text-[var(--color-accent)]">
          {eyebrow}
        </span>
      ...
      <div className="grid gap-5 xl:grid-cols-[1.4fr_1fr]">
        <div className="card-gradient shadow-card rounded-[var(--radius-lg)] border border-[var(--color-border)] p-6">
        ...
        <div className="shadow-card rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
          <h2 className="text-lg font-semibold text-[var(--color-fg)]">
            Next step
          </h2>
          <p className="mt-3 text-sm leading-6 text-[var(--color-fg-muted)]">
